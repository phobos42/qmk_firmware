 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |  "   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  | App  | Alt  |Lower |    Space    |Raise |  ALT |  GUI | CAPS | Ctrl |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, KC_LGUI, KC_APP, KC_LALT,  LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RALT, KC_RGUI, KC_CAPS, KC_RCTL
),
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  _______,   QK_BOOT, DB_TOGG,  _______, _______, _______, _______, _______, _______, _______, _______, _______,//RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, KC_DEL ,
