...
/*
 * _    _                                     __  __                 
 *| | _(_)_ __   __ _  ___   __ _ _ __ _   _ / _|/ _|_ __   ___ _ __ 
 *| |/ / | '_ \ / _` |/ _ \ / _` | '__| | | | |_| |_| '_ \ / _ \ '__|
 *|   <| | | | | (_| | (_) | (_| | |  | |_| |  _|  _| | | |  __/ |   
 *|_|\_\_|_| |_|\__, |\___/ \__, |_|   \__,_|_| |_| |_| |_|\___|_|   
 *              |___/       |___/                                    
 *
 * https://github.com/kingogruffner
 *
 * version 0.9
 */
 ...
 */
  ...
  * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
  * | PR SCR | MUTE   |  PREV  |  VOL+  |  NEXT  |        | P7     | P8     | P9     | -      |   \    |  _     |  =     |    ~   |   `    |
  * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
  * |        |        |  PLAY  |  VOL-  | BACKSP | DELETE | P4     | P5     | P6     |  LEFT  |  DOWN  |   UP   |  RIGHT |        |        |
  * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
  * |        |        |  PAUSE |  APP   | MYCOMP |        | P1     | P2     | P3     |    +   |   {    |   }    |   [    |   ]    |        |
  * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
  ...
  */
     [_LOWER] = LAYOUT_ortho_5x15( /* FUNCTION */
      ...
      KC_PSCR, KC_MUTE, KC_MPRV, KC_VOLU, KC_MNXT,    _______, KC_P7,   KC_P8,   KC_P9,   KC_MINS,  KC_BSLASH,     LSFT(KC_MINUS), KC_EQUAL,  LSFT(KC_GRAVE), KC_GRAVE,
      _______, _______, KC_MPLY, KC_VOLD, KC_BSPACE,  KC_DEL,  KC_P4,   KC_P5,   KC_P6,   KC_LEFT,  KC_DOWN,       KC_UP,          KC_RGHT,   _______,        _______,
      _______, _______, KC_PAUS, KC_APP,  KC_MYCM,    _______, KC_P1,   KC_P2,   KC_P3,   KC_PLUS,  LSFT(KC_LBRC), LSFT(KC_RBRC),  KC_LBRC,   KC_RBRC,        _______,
      _______, _______, _______, _______, MO(_LOWER), KC_SPC,  KC_P0, _______,   KC_PDOT, _______,  MO(_UPPER),    _______,        TG(_KEEB), _______,        _______
    ),
 ...
 * |        |        |        |        |        |        | P1     | P2     | P3     | PENT   |        |        |        |        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        |        |        |        | LOWER  |        | P0     |        | P.     |        | UPPER  |        |        |        | GAMES  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 [_UPPER] = LAYOUT_ortho_5x15( /* FUNCTION */
   KC_F1,   KC_F2,         KC_F3,         KC_F4,         KC_F5,         KC_F6,         KC_NLCK, KC_SLSH, KC_ASTR, KC_F7,         KC_F8,         KC_F9,         KC_F10,        KC_F11,        KC_F12,
   _______, LSFT(KC_1),    LSFT(KC_2),    LSFT(KC_3),    LSFT(KC_4),    LSFT(KC_5),    KC_P7,   KC_P8,   KC_P9,   LSFT(KC_6),    LSFT(KC_7),    LSFT(KC_8),    LSFT(KC_9),    LSFT(KC_0),    _______,
   _______, _______,       _______,       _______,       _______,       _______,       KC_P4,   KC_P5,   KC_P6,   KC_PLUS,       _______,       _______,       _______,       _______,       _______,
   _______, _______,       _______,       _______,       _______,       _______,       KC_P1,   KC_P2,   KC_P3,   KC_PENT,       _______,       _______,       _______,       _______,       _______,
   _______, _______,       _______,       _______,       MO(_LOWER),    _______,       KC_P0,   _______, KC_PDOT, _______,       MO(_UPPER),    _______,       _______,       _______,       TG(_GAMES)
 ),
 /* GAMES
  * .--------------------------------------------------------------------------------------------------------------------------------------.
  * | ESC    | 1      | 2      | 3      | 4      | 5      | -      | `      | =      | 6      | 7      | 8      | 9      | 0      | BACKSP |
